...
lib.ssMetadata = [
		{name:"55_atlas_", frames: [[0,0,800,530],[802,0,54,102]]}
];
...
(lib._55 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({x:40.6,y:384.5},49).wait(1));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/55_atlas_.png?1583603053403", id:"55_atlas_"}
	],
	preloads: []
};
